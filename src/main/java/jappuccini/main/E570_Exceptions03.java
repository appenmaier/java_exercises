...
public class E570_Exceptions03 {
   ...
   public static void main(String[] args) {
       ...
       * Person("Miriam Albers"), 90000)); try { e1.setSalaryInEuro(55000);
       * e2.setSalaryInEuro(77000); e3.setSalaryInEuro(45000); } catch (SalaryDecreaseException |
       * SalaryIncreaseTooHighException e) { System.err.println(e.getMessage()); }
       */
