...
public record Footballer(String name, Position position, LocalDate birthdate, int sizeInCm,
   ...
   public static List<Footballer> getFootballers() {
      ...
      footballers.add(new Footballer("Merle Frohms",
            Position.GOALKEEPER,
            ...
            41,
            0));
      footballers.add(new Footballer("Svenja Huth",
            Position.MIDFIELDER,
            ...
            81,
            14));
      footballers.add(new Footballer("Kathrin Hendrich",
            Position.DEFENDER,
            ...
            59,
            5));
      footballers.add(new Footballer("Sara Doorsoun",
            Position.DEFENDER,
            ...
            46,
            1));
      footballers.add(new Footballer("Felicitas Rauch",
            Position.DEFENDER,
            ...
            34,
            4));
      footballers.add(new Footballer("Melanie Leupolz",
            Position.MIDFIELDER,
            ...
            79,
            13));
      footballers.add(new Footballer("Sara Daebritz",
            Position.MIDFIELDER,
            ...
            98,
            17));
      footballers.add(new Footballer("Lina Magull",
            Position.MIDFIELDER,
            ...
            73,
            22));
      footballers.add(new Footballer("Jule Brand",
            Position.MIDFIELDER,
            ...
            33,
            7));
      footballers.add(new Footballer("Klara Buehl",
            Position.STRIKER,
            ...
            36,
            15));
      footballers.add(new Footballer("Alexandra Popp",
            Position.STRIKER,
